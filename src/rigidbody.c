...
// Link the target rectangle to a rigidbody, this rectangle won't be freed when the rigidbody is destroyed
...
// The rigidbody->definition member won't be freed here, since we just link it in the construtor
